...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_unsigned_hexadecimal.c                                     :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: xkubheka <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/08/09 15:04:14 by xkubheka          #+#    #+#             */
/*   Updated: 2018/08/09 15:04:20 by xkubheka         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static short ft_hend_x_digit(t_flist *lst, uintmax_t digit)
{
	...
	len += (lst->spec == 'X') ? ft_print_x(digit, lst, "0123456789ABCDEF") : ft_print_x(digit, lst, "0123456789abcdef");
